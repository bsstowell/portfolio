<?php
  ...
  $email_to_body = "
                ...
                <h3 style=\"font-size:15px;background-color:darkgray;padding:10px;text-align:center;\"><a href='https://brianstowell.name/portfolio/portfolio.php' style=\"color:white;text-decoration:none;\">Click Here to Return to Brian's Portfolio Site</a></h3>
                </body>
                </html>";
?>
	...
	<div class="container">
		...
		<header>
				<div class="topnav">
					...
					<a href="https://brianstowell.name" target="_blank">Homework</a>
		...
		<div class="alignHeader2">
			...
			<div>
				<video autoplay width="320" height="240">
					<source src="images/me.mp4" type="video/mp4" class="video">
		...
		<p class="alignSmallBox">
			Welcome to my portfolio page! My name is Brian, and I am currently a student at DMACC finishing
			my Web Development degree. I am completing my final semester, so I created this page to display what I
		...
		<p class="alignSmallBox" style="text-align:center;">Hover over the blocks below and click the links to view
	...
	<div class="flex-container">
			...
			<div class="flip-card-inner">
				...
				<div class="flip-card-back alignBoxBack">
					<div class="centered"><a
						...
						target="_blank">Biggie B's Memorabilia</a>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="flip-card">
			...
			<div class="formPadding">
				<form id="contact" name="contact" method="post" action="portfolio.php" >
					<h1>Contact Me</h1>
					<div>
